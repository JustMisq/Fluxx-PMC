  ...
  return (
    <>
      <PageHero
        ...
        text="FLUXX PMC maintains a diversified fleet of combat, support, and reconnaissance vessels. All assets are mission-configured and deployment-ready."
        classification="restricted"
        status={{ label: "FLEET ACTIVE", variant: "green" }}
      />
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-[10px] text-brand-text-muted/60 tracking-wider uppercase">
                      {ship.manufacturer}
                    </p>
                  </div>
              ...
              <div className="p-6 lg:p-8 space-y-6">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <h2 className="text-2xl font-black text-white">{selectedShip.name}</h2>
                ...
                <div className="border-t border-white/5 pt-4">
                  <p className="text-[9px] text-brand-text-muted/40 tracking-wider">
                    FLUXX-FLEET-REG // {selectedShip.name.toUpperCase().replace(/ /g, "-")}-001
                  </p>
                </div>
              </div>
            </motion.div>
